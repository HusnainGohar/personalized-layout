...
def preprocess_clay_labels(input_path, output_path):
    ...
    # Adjust these lists based on your clay_labels.csv schema
    possible_cat_cols = ['component', 'label', 'type', 'color', 'state']
    possible_num_cols = ['x', 'y', 'width', 'height', 'font_size']
...
if __name__ == "__main__":
    input_path = "data/raw/clay_labels.csv"
    output_path = "data/processed/clay_labels_processed.csv"
    if not os.path.exists(input_path):
        print(f"ERROR: Input file not found at {input_path}")
    else:
        preprocess_clay_labels(input_path, output_path)
